                ...
                <form method="post" id="logIN">
                    <div class="py-2 px-2 form-field ">
                        <label class="block">
                            ...
                            <input type="email"  class="mt-1 px-3 py-2 bg-white border shadow-sm 
                    ...
                    <div class="py-2 flex justify-center">
                        ...
                        hover:text-white transition ease-out duration-500 tracking-wider" id="entrer" name="seConnecter"><span>Se connecter</span></button>
                    </div>
