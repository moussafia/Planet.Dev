                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody name="tbMY">
                            <tr class="bg-white dark:bg-gray-800">
                                <th scope="row"
                                    class="titleMYarticle px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <?= $row['title'];  ?>
                                </th>
                                <td class="px-6 py-4">
                                <?= $row['category'];  ?>
                                ...
                                <td class="hidden"><input type="hidden" value="<?= $row['id'] ?> " class="articleType"></td>
